...
## Plotting examples of the data
#sync_raw$HR1 %>% matplot(type="l")# Plot
#sync_raw$HR2 %>% matplot(type="l")# Plot
#sync_raw$ECG1%>% matplot(type="l")# Plot
#sync_raw$ECG2%>% matplot(type="l")# Plot
#sync_raw$Resp1 %>% matplot(type="l")# Plot
#sync_raw$Resp2 %>% matplot(type="l")# Plot

#sync_2$HR1 %>% matplot(type="l")# Plot
#sync_2$HR2 %>% matplot(type="l")# Plot
#sync_2$ECG1%>% matplot(type="l")# Plot
#sync_2$ECG2%>% matplot(type="l")# Plot
#sync_2$Resp1 %>% matplot(type="l")# Plot
#sync_2$Resp2 %>% matplot(type="l")# Plot

#sync_3$HR1 %>% matplot(type="l")# Plot
#sync_3$HR2 %>% matplot(type="l")# Plot
#sync_3$ECG1%>% matplot(type="l")# Plot
#sync_3$ECG2%>% matplot(type="l")# Plot
#sync_3$Resp1 %>% matplot(type="l")# Plot
#sync_3$Resp2 %>% matplot(type="l")# Plot

p4 <- ggplot(data = sync_4) +
...
HR_model3 <- lmer(HR_change_self ~ 0 + condition +(HR_self + HR_other):condition + (0+condition|participant), data = phys_4)
summary(HR_model3)
...
#write.csv(surrogate_all_2, "Surrogate Long Data.csv")

#surrogate_long <- read.csv("Surrogate Long Data.csv")
...
## We will only analyze data from Study 4, because that is easier.
phys_4 <- really_long %>% filter(study == 4)
...
HR_model <- lm(HR_change_self ~ (0 + condition + (HR_self + HR_other)*condition)*Type, data = phys_4)

HR_model2 <- lm(HR_change_self ~ (0 + condition + (HR_self + HR_other):condition):Type, data = phys_4)
...
### Adding random effects (Buckle in! It's going to be a bumpy ride!)
HR_model3 <- lmer(HR_change_self ~ (0 + condition +(HR_self + HR_other):condition):Type + (0+condition|participant), data = phys_4)
summary(HR_model3)
